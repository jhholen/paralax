 ...
 */
 ...
 /* Add backstretch scripts */
function my_custom_scripts() {
    if ( !is_admin() ) {
        
        wp_register_script( 'para', get_stylesheet_directory_uri() . '/js/parallax.js', 'jquery', '1.0', true);
        wp_enqueue_script( 'para' );
        wp_register_script( 'gallery', get_stylesheet_directory_uri() . '/js/gallery.js', 'jquery', '1.0', true);
        wp_enqueue_script( 'gallery' );

        wp_register_script( 'stellar', get_stylesheet_directory_uri() . '/js/jquery.stellar.js', 'jquery', '1.0', true);
        wp_enqueue_script( 'stellar' );
        wp_register_script( 'iscroll', get_stylesheet_directory_uri() . '/js/iscroll.js', 'jquery', '1.0', true);
        wp_enqueue_script( 'iscroll' );

        wp_register_script( 'inst', get_stylesheet_directory_uri() . '/js/app.js', 'jquery', '1.0', true);
        wp_localize_script( 'inst', 'instagram', array( 'ajaxurl' => admin_url( 'app.php' )));        
        wp_enqueue_script( 'inst' );

        wp_register_script( 'gallery_init', get_stylesheet_directory_uri() . '/js/bg.js', 'jquery', '1.0', true);
        wp_enqueue_script( 'gallery_init' );
...
/* Add backstretched image by page */
