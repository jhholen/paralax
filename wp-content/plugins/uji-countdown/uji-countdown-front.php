...
function ujic_code( $atts, $content = null ) { 
	...
	wp_localize_script('js_countdown', 'ujiCount', array( 
						...
						'Days' 			=> __("Dager", "uji-countdown"),
						'Hours' 		=> __("Timer", "uji-countdown"),
						'Minutes' 		=> __("Minutter", "uji-countdown"),
						'Seconds' 		=> __("Sekunder", "uji-countdown"),
						'Year' 			=> __("Year", "uji-countdown"),
						'Month' 		=> __("Month", "uji-countdown"),
						'Week'			=> __("Week", "uji-countdown"),
						'Day' 			=> __("Dag", "uji-countdown"),
						'Hour' 			=> __("Time", "uji-countdown"),
						'Minute' 		=> __("Minutt", "uji-countdown"),
						'Second' 		=> __("Sekund", "uji-countdown"),
